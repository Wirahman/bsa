<div class="container">
	<h2 class="judul">Shipment Inbound Entry (AIR)</h2>
	<div id="alert"></div>
		...
		<fieldset>
			<div class="row">
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append"><input type="text" name="order_no" id="order_no" oldvalue="" browseobj="cari_order_no" /><a style="display:none" class="add-on browse" id="cari_order_no" href="cari?ref=order_no&tipe=shipment_inbound_entry_air" title="Click For Search Order No."><i class="icon-search"></i></a></div>
					</div>
				</div>
				<div class="control-group span6" style="height:15px">
...
<!--							<li><a href="#biaya" class="tab" title="Klik untuk mengisi informasi biaya lain">B. Lain</a></li>-->
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_shipment_inbound_entry_air', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_shipment_inbound_entry_air', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_shipment_inbound_entry_air', unserialize($capabilities) ) ){ ?>
...
preventempty="order_no,order_date,HAWB_no,MAWB_no,quotation_ref";
