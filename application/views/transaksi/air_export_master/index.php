<div class="container">
	<h2 class="judul">Export Master (AIR)</h2>
	<div id="alert"></div>
		...
		<fieldset>
			<div class="row">
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append"><input type="text" name="MAWB_no" id="MAWB_no" oldvalue="" browseobj="cari_MAWB_no" /><a style="display:none" class="add-on browse" id="cari_MAWB_no" href="cari/ref/MAWB_no/tipe/air_export_master" title="Click For Search MAWB No."><i class="icon-search"></i></a></div>
					</div>
				</div>
				<div class="control-group span6" style="height:15px">
...
<!--							<li><a href="#biaya" class="tab" title="Klik untuk mengisi informasi biaya lain">B. Lain</a></li>-->
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_air_export_master', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_air_export_master', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_air_export_master', unserialize($capabilities) ) ){ ?>
...
preventempty="MAWB_no,order_date";
