<div class="container">
	<h2 class="judul">Gross Profit Export (SEA)</h2>
	<div id="alert"></div>
	<form class="form-horizontal">
		<fieldset>
				...
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append">
							...
							<a style="display:none" class="add-on browse" id="cari_gp_no" href="cari?ref=gp_no&tipe=sea_gross_profit_export" title="Click For Search GP No">
				...
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append">
							...
							<a style="display:none" class="add-on browse" id="cari_POL_id" href="cari?ref=POL_id&tipe=sea" title="Click For Search POL ID"><i class="icon-search"></i></a>
						</div>
				...
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append">							
							...
							<a style="display:none" class="add-on browse" id="cari_POD_id" href="cari?ref=POD_id&tipe=sea" title="Click For Search Port Of Destination"><i class="icon-search"></i></a>
						</div>
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_sea_gross_profit_export', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_sea_gross_profit_export', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_sea_gross_profit_export', unserialize($capabilities) ) ){ ?>
...
preventempty="gp_no,order_date,HBL_no,etd,POL_id,POD_id,sales_id,prepared,approved,remarks";
...
$( document ).ready( function() {
	...
	$( '.cost-vendor_id' ).live( 'blur', function(){
		...
		if($( this ).val()==''){
			...
			if ($( this ).val()!==$( this ).attr('oldvalue')){
				$.post( 'db_read_pr_sea', { id: $( this ).val() }, function( result ){
