<div class='container'>
	<h2 class="judul">Export Master (SEA)</h2>
	<div id="alert"></div>
		...
		<fieldset>
			<div class="row">
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append"><input type="text" name="OBL_no" id="OBL_no" oldvalue="" browseobj="cari_OBL_no" /><a style="display:none" class="add-on browse" id="cari_OBL_no" href="cari?ref=OBL_no&tipe=sea_export_master" title="Click for search OBL number"><i class="icon-search"></i></a></div>
					</div>
				</div>
				<div class="control-group span6" style="height:15px">
				...
				<div class="control-group span9">
					<div class="controls">
						<ul class="nav nav-tabs nav-justified selector" id="meta">
							<li class="active"><a href="#parties" class="tab" title="Click for filled the parties information"> The Parties</a></li>
							<li><a href="#portvessel" class="tab" title="Click for filled port and vessel information">Port and Vessel</a></li>
							<li><a href="#shipment" class="tab" title="Click for filled shipment detail">Shipment Detail</a></li>
							<li><a href="#particulars" class="tab" title="Click for filled particulas information">Particulars</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="tab-content ">
				<div class="span12 tab-pane active" style="height:300px;width:1300px" id="parties">
					<div class="row">
						<div class="control-group span6">
							...
							<div class="controls">
								<div class="input-append"><input type="text" name="shipper_id" id="shipper_id" oldvalue="" browseobj="cari_shipper_id"><a style="display:none" class="add-on browse" id="cari_shipper_id" href="cari?ref=shipper_id&tipe=customer&cond1=shipper" title="Click for search shipper id"><i class="icon-search"></i></a></div>
							</div>
							<div class="controls">
						...
						<div class="control-group span6">
							...
							<div class= "controls">
								<div class="input-append"><input type="text" name="cnee_id" id="cnee_id" oldvalue="" browseobj="cari_cnee_id" /><a style="display:none" class="add-on browse" id="cari_cnee_id" href="cari?ref=cnee_id&tipe=customer&cond1=consignee" title="Click for Search Consignee ID"><i class="icon-search"></i></a></div>
						</div>
						<div class="controls">
				...
				<div class="row">
					<div class="control-group span6">
						...
						<div class="controls">
							<div class="input-append"><input type="text" name="notify_id" id="notify_id" oldvalue="" browseobj="cari_notify_id" /><a style="display:none" class="add-on browse" id="cari_notify_id" href="cari?ref=notify_id&tipe=customer" title="Click for Search Notify ID"><i class="icon-search"></i></a></div>
						</div>
						<div class="controls">
					...
					<div class="controls-group span6">
						...
						<div class="controls">
							<div class="input-append"><input type="text" name="agent_id" id="agent_id" oldvalue="" browseobj="cari_agent_id" /><a style="display:none" class="add-on browse" id="cari_agent_id" href="cari?ref=agent_id&tipe=customer&cond1=agent" title="Click for Search Agent ID"><i class="icon-search"></i></a></div>
						</div>
						<div class="controls">
			...
			<div class="span12 tab-pane portvessel" style="height:300px;width:1300px" id="portvessel">
				...
				<div class="row">
					<div class="control-group span6" style="height:15px">
						...
						<div class="controls">
							<div class="input-append"><input type="text" name="port_kode_discharge" id="port_kode_discharge" oldvalue="" browseobj="cari_kode_seaport_discharge" style="width:50px" /><a style="display:none" class="add-n browse" id="cari_kode_seaport_discharge" href="cari?ref=port_kode_discharge&tipe=sea" title="Click For Search Seaport Code"><i class="icon-search"></i></a></div>
							<input type="text" style="width:110px" readonly="readonly" name="nama_port_discharge" id="nama_port_discharge" />
						</div>
					</div>
					<div class="control-group span6" style="heright:15px">
						<label class="control-label" for="port_code">Port of Destination :</label>
						<div class="controls">
							<div class="input-append"><input type="text" name="port_kode_destination" id="port_kode_destination" oldvalue="" browseobj="cari_kode_seaport_destination" style="width:50px" /><a style="display:none" class="add-on browse" id="cari_kode_seaport_destination" href="cari?ref=port_kode_destination&tipe=sea" title="Click For Seaport Code"><i class="icon-search"></i></a></div>
				...
				<div class="row">
					<div class="control-group span6" style="height:15px">
						<label class="control-label" for="carrier_code">Carrier Code</label>
						<div class="controls">
							<div class ="input-append"><input style="width:110px" type="text" name="carrier_code" id="carrier_code" oldvalue="" browseobj="cari_carrier_code" /><a style="display:none" class="add-on browse" id="cari_carrier_code" href="cari?ref=carrier_code&tipe=carrier_booking_sea" title="Click for Search Carrier Code"><i class="icon-search"></i></a></div>
			...
			<div class="span12 tab-pane shipment" style="height:300px;width:1300px" id="shipment">
				...
				<div class="row">
					<div class="control-group span6" style="height:15px">
						...
						<div class="controls">
							<div class="input-append"><input style="width:110px" type="text" name="commodity_code" id="commodity_code" oldvalue="" browseobj="cari_commodity_code" /><a style="display:none" class="add-on browse" id="cari_commodity_code" href="cari?ref=commodity_code&tipe=com" title="Click For Search Commodity Code"><i class="icon-search"></i></a></div>
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_sea_export_master', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_sea_export_master', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_sea_export_master', unserialize($capabilities) ) ){ ?>
...
$( document ).ready( function() {
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_customer', { id: $( '#shipper_id' ).val(), cond:'shipper' }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Shipper Code Not Found.</div>';
						$('#alert').html( message );
						$( "#keterangan_shipper" ).val( '' );
						$( "#shipper_id" ).val( '' );
						$( '#shipper_id' ).focus();
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_customer', { id: $( '#cnee_id' ).val(), cond:'consignee' }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Consignee Code Not Found.</div>';
						$('#alert').html( message );
						$( "#keterangan_cnee" ).val( '' );
						$( "#cnee_id" ).val( '' );
						$( '#cnee_id' ).focus();
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_customer', { id: $( '#notify_id' ).val(), cond: '' }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Notify Code Note Found.</div>';
						$('#alert').html( message );
						$( "#keterangan_notify" ).val( '' );
						$( "#notify_id" ).val( '' );
						$( '#notify_id' ).focus();
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_customer', { id: $( '#agent_id' ).val(), cond:'agent'  }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Agent Code Not Found.</div>';
						$('#alert').html( message );
						$( "#keterangan_agent" ).val( '' );
						$( "#agent_id" ).val( '' );
						$( '#agent_id' ).focus();
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_commodity', { id: $( '#commodity_code' ).val() }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Commodity Code.</div>';
						$('#alert').html( message );
						$( "#commodity_name" ).val( '' );
						$( "#commodity_code" ).val( '' );
						$( '#commodity_code' ).focus();
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_freight_term', { id: $( '#freight_term_code' ).val() }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Freight Code Not Found.</div>';
						$('#alert').html( message );
						$( "#freight_term_name" ).val( '' );
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_port', { id: $( '#port_kode_loading' ).val() }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Port Code Not Found.</div>';
						$('#alert').html( message );
						$( "#nama_port_loading" ).val( '' );
		...
		if ($( this ).val()===''){
			...
			if ($(this).val()!== $(this).attr("oldvalue")){
				$.post( 'db_read_carrier', { id: $( '#carrier_code' ).val() }, function( result ){
					if( result === '' ){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Company Code Not Found.</div>';
						$('#alert').html( message );
						$( "#carrier_description" ).val( '' );
						$( "#carrier_code" ).val( '' );
						$( '#carrier_code' ).focus();
	...
	// Contoh pencarian menggunakan kondisi
			...
			if ($( this ).val()!==$( this ).attr('oldvalue')){
				$.post( 'db_read_vessel', { id: $( this ).val() }, function( result ){
					...
					if( result === ''  || result===null){
						var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Vessel Code Not Found.</div>';
						$('#alert').html( message );
						$( '#'+asal.replace( 'code', 'name' ) ).val( '' );
						$( '#'+asal ).val( '' );
						$(this).val('');
		...
		if( $( '#OBL_no' ).val() !== '' ){
			$.post( 'db_create', $( 'form' ).serialize(), function( result ){
				...
				if( success['status'] ==='Error' ){
					var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Warning!</strong> Data '+$( '#OBL_no' ).val()+' Failed. '+ success['ket'] +'</div>';
					$('#alert').html( message );					
					if (success['ket']=='Data Already Exist.'){
						nomorbaru();
					}
				}else if( success['status'] ){
					var message = '<div class="alert alert-success" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Success!</strong> Data '+$( '#OBL_no' ).val()+' Complete.</div>';
					$('#alert').html( message );
					initializex();
				} else {
					var message = '<div class="alert alert-error" data-dismiss="alert"><a href="#" class="close">&times;</a><strong>Error!</strong> Data '+$( '#OBL_no' ).val()+' Failed.</div>';
					$('#alert').html( message );
				}
			});
		} else {
