<div class="container">
	<h2 class="judul">Booking Cargo (SEA)</h2>
	<div id="alert"></div>
...
<!--							<li><a href="#biaya" class="tab" title="Klik untuk mengisi informasi biaya lain">B. Lain</a></li>-->
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_booking_cargo_sea', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_booking_cargo_sea', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_booking_cargo_sea', unserialize($capabilities) ) ){ ?>
...
preventempty="order_no,order_date,HBL_no,OBL_no,SI_ref,quotation_ref";
