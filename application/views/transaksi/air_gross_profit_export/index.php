<div class="container">
	<h2 class="judul">Gross Profit Export (AIR)</h2>
	<div id="alert"></div>
	<form class="form-horizontal">
		<fieldset>
				...
				<div class="control-group span6" style="height:15px">
					...
					<div class="controls">
						<div class="input-append">
							...
							<a style="display:none" class="add-on browse" id="cari_gp_no" href="cari?ref=gp_no&tipe=air_gross_profit_export" title="Click For Search GP No">
			...
			<div class="span12 form-actions btn-group">
				<?php if( in_array( 'create_air_gross_profit_export', unserialize($capabilities) ) ){ ?>
				...
				<?php if( in_array( 'update_air_gross_profit_export', unserialize($capabilities) ) ){ ?>
				<a href="#" class="btn btn-primary ubah" style="top:-15px"><i class="icon-pencil icon-white"></i> Ubah</a>
				<?php } ?>
				<?php if( intval($role)!= 1){ ?>
					<?php if( in_array( 'delete_air_gross_profit_export', unserialize($capabilities) ) ){ ?>
